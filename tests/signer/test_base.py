...
class TestSigner(object):
    ...
    def test_confirm_signature_prompt(self,
                                      mock_input,
    ...
    def test_confirm_signature_prompt_in_session(self,
                                      mock_input,
                                      mock_display_qr_code,
                                      mock_request):
    ...
    def test_no_request_raises_error_parse_request(self,
                                                   mock_parse_request,
                                                   mock_input,
                                                   mock_display_qr_code):
        with pytest.raises(hermit.errors.HermitError) as e_info:
    ...
    def test_decline_signature_prompt(self,
