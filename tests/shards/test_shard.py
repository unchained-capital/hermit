...
class TestShard(object):
    ...
    def test_decrypt_shard(
        self, encrypted_mnemonic_1, password_1, unencrypted_mnemonic_1
    ):
    ...
    def test_reencrypt_shard(
        self, encrypted_mnemonic_1, password_1, password_2, unencrypted_mnemonic_1
    ):
        shard = Shard("foo", encrypted_mnemonic_1, self.interface)
        ...
        # back.
        self.interface.get_change_password.side_effect = [
